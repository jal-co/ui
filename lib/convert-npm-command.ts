...
export function convertNpmCommand(npmCommand: string): PackageManagerCommands {
  ...
  // Supports all shadcn CLI subcommands (add, init, diff, build, etc.)
  // and preserves flags like -y, --overwrite, --cwd, etc.
  ...
  // Fallback: return as-is for npm, best-effort for others
  return {
    npm: trimmed,
