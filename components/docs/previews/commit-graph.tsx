...
// Simulate a realistic git history with branches and merges
const commits = [
  { hash: "a1b2c3d", message: "feat(auth): add OAuth2 support", author: { name: "Sarah Chen", avatarUrl: "https://github.com/shadcn.png?" }, date: new Date(Date.now() - 2 * 3600_000).toISOString(), parents: ["m1e2r3g"], refs: ["main"], tag: "v2.1.0" },
  { hash: "m1e2r3g", message: "Merge branch 'feat/dashboard' into main", author: { name: "Sarah Chen", avatarUrl: "https://github.com/shadcn.png?" }, date: new Date(Date.now() - 6 * 3600_000).toISOString(), parents: ["f6e5d4c", "d4a5s6h"], refs: ["main"] },
  ...
  { hash: "4d5e6f1", message: "chore(deps): upgrade next to 15.5", author: { name: "Sarah Chen", avatarUrl: "https://github.com/shadcn.png?" }, date: new Date(Date.now() - 5 * 86400_000).toISOString(), parents: ["0a1b2c3"], tag: "v2.0.0" },
