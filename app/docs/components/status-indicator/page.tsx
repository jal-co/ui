...
const sourceFiles = ["registry/status-indicator/status-indicator.tsx"]
  ...
  return (
    <ComponentDocsPage
      ...
      usage={
        <>
          <CodeLine
            code={`import { StatusIndicator } from "@/components/status-indicator"`}
          />
      ...
      <StatusIndicator status={status} size="sm" />
                ...
                preview: (
                  <div className="flex flex-col divide-y divide-border/40 rounded-xl border border-border/60 bg-card shadow-sm">
                    {[
                      { name: "API", status: "operational" as Status },
                      { name: "Database", status: "operational" as Status },
                      { name: "CDN", status: "degraded" as Status },
                      { name: "Search", status: "maintenance" as Status },
                    ].map(({ name, status }) => (
                      <div
                        key={name}
        ...
        <ApiRefTable
          ...
          props={[
            ...
            },
            {
              ...
              type: "string",
              description:
                'Custom label text. Auto-generated from status when omitted (e.g. "operational" → "Operational").',
            },
            {
              name: "size",
              type: '"sm" | "md" | "lg"',
