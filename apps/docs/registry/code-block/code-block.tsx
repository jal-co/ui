 ...
 * ui.justinlevine.me
 *
 * Multi-line code block with syntax highlighting, bundled language icon,
 * copy button, and configurable overflow (default, scrollable, collapsible).
 *
 * Props:
 * - code: source code string
 * - language?: shiki language key, defaults to "tsx"
 * - title?: optional header title
 * - icon?: custom ReactNode to override the bundled language icon
