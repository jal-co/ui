...
### 8. Ship docs as part of the component

Public component work is not done until the docs are updated.
...
2. Inspect related repo patterns.
3. Define use case, API, variants, file structure, and dependency needs.
4. Implement the component with a one-file bias.
5. Create or update previews and demos with realistic content.
6. Update docs and registry metadata when public.
7. Review against the quality, file-boundary, and dependency checklists.
